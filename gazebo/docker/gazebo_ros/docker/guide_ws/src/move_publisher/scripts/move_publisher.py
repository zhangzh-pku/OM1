    ...
    try:
        while not rospy.is_shutdown():
            ...
            try:
                ...
                user_input = input("Enter vx, vy, vyaw (separated by spaces, values between -1.0 and 1.0). E.g. 0.5 0.0 0.0 to begin walking forward: ")
                vx, vy, vyaw = map(float, user_input.split())
            except ValueError:
                rospy.logwarn("Invalid input. Please enter three numeric values separated by spaces.")
                continue
