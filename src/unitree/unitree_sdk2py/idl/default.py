...
def geometry_msgs_msg_dds__PoseWithCovarianceStamped_():
    return PoseWithCovarianceStamped_(
        std_msgs_msg_dds__Header_(), geometry_msgs_msg_dds__PoseWithCovariance_()
    )
...
def geometry_msgs_msg_dds__TwistWithCovarianceStamped_():
    return TwistWithCovarianceStamped_(
        std_msgs_msg_dds__Header_(), geometry_msgs_msg_dds__TwistWithCovariance_()
    )
...
def nav_msgs_msg_dds__MapMetaData_():
    return MapMetaData_(
        builtin_interfaces_msgs_msg_dds__Time_(), 0, 0, geometry_msgs_msg_dds__Pose_()
    )
...
def unitree_hg_msg_dds__LowCmd_():
    return HGLowCmd_(
        0, 0, [unitree_hg_msg_dds__MotorCmd_() for i in range(35)], [0, 0, 0, 0], 0
    )
...
def unitree_api_msg_dds__ResponseHeader_():
    return ResponseHeader_(
        unitree_api_msg_dds__RequestIdentity_(), unitree_api_msg_dds__ResponseStatus_()
    )
