...
[Input plugin code examples](https://github.com/OpenmindAGI/OM1/blob/main/src/inputs/plugins)
...
- [VLM_Vila](https://github.com/OpenmindAGI/OM1/blob/main/src/inputs/plugins/vlm_vila.py)
