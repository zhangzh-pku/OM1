...
- [Required Operating System Versions](#required-operating-system-versions)
  * [Required Software for the Raspberry Pi](#required-software-for-the-raspberry-pi)
  * [Required Software for the Create3](#required-software-for-the-create3)
...
- [OM1 Installation and Launch](#om1-installation-and-launch)
  ...
  * [Interacting with TurtleBot4 from a Remote Computer using Zenoh and the Command Line](#interacting-with-turtlebot4-from-a-remote-computer-using-zenoh-and-the-command-line)
    + [Steer the TurtleBot4 with your Laptop Keyboard](#steer-the-turtlebot4-with-your-laptop-keyboard)
    + [Read TurtleBot4 Laserscan Data](#read-turtlebot4-laserscan-data)
    + [Read TurtleBot4 Battery Data](#read-turtlebot4-battery-data)
...
For fully autonomous use, install OM1 on the TurtleBot4's Raspberry Pi. On the RPi terminal command line, follow these [instructions](/docs/getting-started/raspberrypi.mdx). When you see all the right topics listed in `ros2 topic list`, your TurtleBot4 is set up and you are ready to install OM1.
