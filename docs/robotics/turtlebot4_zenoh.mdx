...
To enable full range of motion, set `ros2 param set /$URID/c3/motion_control safety_override backup_only`. This removes the cliff protection, which limits backwards movements to 1 cm. 
...
docker build -t jliphard/turtlebridge .
docker push jliphard/turtlebridge
