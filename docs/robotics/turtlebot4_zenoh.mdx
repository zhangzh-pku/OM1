...
On the TurtleBot4 command line, run `ros2 topic list`. Topics with a `pi` prefix originate from the RPi, and topics without a prefix are from the Create3. If you do not have an non-prefixed topics, your Create3 is not talking correctly to the RPi.
