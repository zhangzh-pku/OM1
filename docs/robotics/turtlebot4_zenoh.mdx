...
- [Required Operating System Versions](#required-operating-system-versions)
  * [Required software for the Turtlebot4's Raspberry Pi](#required-software-for-the-turtlebot4-raspberry-pi)
  * [Required software for the Turtlebot4's Create3](#required-software-for-the-turtlebot4-create3)
...
- [Configure the TurtleBot4](#configure-the-turtlebot4)
  * [Configure the TurtleBot4's Internal RPi4](#configure-the-turtlebot4-internal-rpi4)
  * [Configure the TurtleBot4's Internal Create3](#configure-the-turtlebot4-internal-create3)
  * [Install docker and configure the docker-compose.yaml file](#install-docker-and-configure-the-docker-compose-yaml-file)
...
### Required software for the Turtlebot4 Raspberry Pi
...
### Required software for the Turtlebot4 Create3
