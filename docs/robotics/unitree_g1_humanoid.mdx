...
- [ORIN/G1: System Description](#orin%2Fg1%3A-system-description)
  * [ORIN: Set default input and output Audio devices](#orin%3A-set-default-input-and-output-audio-devices)
