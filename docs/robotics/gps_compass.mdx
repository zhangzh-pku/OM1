...
and you should see it. At this point if you're not sure which device is the Arduino board, run `sudo dmesg` and looks for entires with "Arduino" in it. This way you will easily spot the serial device name of your Arduino. You can read the data with:
