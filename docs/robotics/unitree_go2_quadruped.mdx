...
Next, set `CYCLONEDDS_HOME`, `CMAKE_PREFIX_PATH`, and `CYCLONEDDS_URI` to the correct values for your computer. An example for a typical Mac installation is provided below. You should add these paths to your environment via your `.zshrc` or equivalent.
