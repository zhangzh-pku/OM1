...
OM1 will provide LIDAR and other data to a system of LLMs, allowing them to explore indoor and outdoor environments. You can also manually control the dog via the Xbox game controller. Press:
